  ...
  <div class="my-2 flex w-full h-full text-center justify-center items-center">
    ...
    <div class="relative">
      ...
      <div class="relative">
        ...
        <div class="absolute left-0 top-12 z-10 rounded-lg bg-slate-700 p-2 flex flex-col gap-2" v-if="showEngineSelect" v-click-outside="() => showEngineSelect = false">
